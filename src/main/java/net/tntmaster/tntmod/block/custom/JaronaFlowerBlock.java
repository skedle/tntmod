...
public class JaronaFlowerBlock extends FlowerBlock {
    public static final BooleanProperty HAVE_FACE = BooleanProperty.create("have_face");

    public JaronaFlowerBlock(Supplier<MobEffect> effectSupplier, int pEffectDuration, Properties pProperties) {
