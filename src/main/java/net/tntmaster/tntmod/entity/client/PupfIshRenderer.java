...
public class PupfIshRenderer extends MobRenderer<PupfishEntity, PupfishModel<PupfishEntity>> {

    public PupfIshRenderer(EntityRendererProvider.Context pContext) {
    ...
    public ResourceLocation getTextureLocation(PupfishEntity pEntity) {
        return new ResourceLocation(Tntmod.MODID, "textures/entity/pupfish.png");
    }
